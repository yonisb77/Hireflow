...
import { AlertCircle, CheckSquare, ChevronRight, Clock, Crown, ExternalLink, FilterX, Paperclip, Plus, Sparkles, X } from 'lucide-react'
                      ...
                      {(provided, snapshot) => (
                        ...
                        >
                          ...
                          {stageCandidates.map((candidate, index) => {
                            ...
                            return (
                              <Draggable key={candidate.id} draggableId={candidate.id} index={index} isDragDisabled={ats.selectionMode}>
                                {(provided, snapshot) => (
                                  <div
                                    ref={provided.innerRef}
